<template>
  ...
  <PassengerCarOperatingHoursNormEditModal
  ...
  <PassengerCarTechnicalMaintenanceNormEditModal
...
import PassengerCarNormEditModal from '../components/PassengerCarNormEditModal.vue';
import PassengerCarOperatingHoursNormEditModal from '../components/PassengerCarOperatingHoursNormEditModal.vue';
import PassengerCarTechnicalMaintenanceNormEditModal from '../components/PassengerCarTechnicalMaintenanceNormEditModal.vue';
...
const { sortBy: fuelSortBy, sortOrder: fuelSortOrder, loadSortState: loadFuelSortState, setSortOrder: setFuelSortOrder } = useSortState('light_vehicle_fuel_norms');
const { sortBy: operatingHoursSortBy, sortOrder: operatingHoursSortOrder, loadSortState: loadOperatingHoursSortState, setSortOrder: setOperatingHoursSortOrder } = useSortState('light_vehicle_operating_hours_norms');
const { sortBy: technicalSortBy, sortOrder: technicalSortOrder, loadSortState: loadTechnicalSortState, setSortOrder: setTechnicalSortOrder } = useSortState('light_vehicle_technical_norms');
