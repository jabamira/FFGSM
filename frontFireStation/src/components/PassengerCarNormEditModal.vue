    ...
    >
      <div class="space-y-4">
        ...
        <SelectInput
          v-model="form.car"
          :options="carOptions"
          :label="fieldDefinitions.normsPassengerCars.car.label"
          :hint="fieldDefinitions.normsPassengerCars.car.hint"
          :required="fieldDefinitions.normsPassengerCars.car.required"
        ...
        <TextInput
          ...
          disallowMinus
          :min="fieldDefinitions.normsPassengerCars.city_norm.minValue"
          :max="fieldDefinitions.normsPassengerCars.city_norm.maxValue"
        />
        <TextInput
...
const submitAdd = async () => {
  ...
  const validationErrors = validateFormFields(form.value, fieldDefinitions.normsPassengerCars);
  ...
  try {
    ...
    const response = await axios.post('passenger-car-norms/', payload, {
...
const submitEdit = async () => {
  ...
  try {
    ...
    const response = await axios.patch(`passenger-car-norms/${editingId.value}/`, payload, {
      headers: { Authorization: `Bearer ${props.auth.access}` },
    });
