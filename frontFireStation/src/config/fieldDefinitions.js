...
export const fieldDefinitions = {
  ...
  waybillRecord: {
    ...
    distance_city_km: {
      ...
      maxValue: 900,
      onlyDigits: true,
      hint: "Только цифры, максимум 900 км (ограничение для предотвращения переполнения моточасов)",
    },
    distance_area_km: {
      label: "Км по области",
      required: true,
    ...
    fuel_refueled: {
      ...
      maxDigits: 6,
      decimalPlaces: 3,
      hint: "Минимум 0, максимум 999.999, до 3 знаков после запятой/точки",
    },
    fuel_used: {
  ...
  operatingHours: {
    operating_hours: {
      ...
      maxDigits: 6,
      decimalPlaces: 3,
      hint: "От 0 до 999.999, до 3 знаков после запятой/точки. ВНИМАНИЕ: превышение вызовет ошибку БД!",
    },
    date: {
      label: "Дата",
      required: true,
      type: "date",
      hint: "Укажите дату записи моточасов",
    },
  },
